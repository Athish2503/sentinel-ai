...
from app.api.v1.endpoints import health, sessions, tool_calls, baselines, alerts, agent, baseline_train, detect, simulate
...
api_router.include_router(simulate.router, tags=["Simulator"])
